            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-nav-link href="/teachers" :active="request()->is('teacher')">Teachers</x-nav-link>
                        <x-nav-link href="/subjects" :active="request()->is('subject')">Subjects</x-nav-link>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
            <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                    <div class="text-base/5 font-medium text-white">Zanadin Akbar</div>
                    <div class="text-sm font-medium text-gray-400">shofi@aulia.com</div>
                </div>
            </div>
